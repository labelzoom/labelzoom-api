 ...
 */
@Getter @Setter
public class CBarcodeLogmars extends ALinearBarcode implements IBarcodeWithWideToNarrowRatio
{
     ...
     */
    public CBarcodeLogmars() { this(null, false); }

    /**
     * Cloning constructor
     * @param original the CBarcodeLogmars to clone
     */
    ...
    {
        return new CBarcodeLogmars(this, cloneData);
    }
}
