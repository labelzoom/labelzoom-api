 ...
 */
@Getter @Setter
public class CBarcodePlessey extends ALinearBarcode implements IBarcodeWithCheckDigit, IBarcodeWithWideToNarrowRatio
{
     ...
     */
    public CBarcodePlessey() { this(null, false); }

    /**
     * Cloning constructor
     * @param original the CBarcodePlessey to clone
     */
    protected CBarcodePlessey(final CBarcodePlessey original, final boolean cloneData)
    {
        super(original, cloneData);
        barcodeStyle = BarcodeStyle.Plessey;
        if (original != null)
        {
    ...
    {
        return new CBarcodePlessey(this, cloneData);
    }
}
